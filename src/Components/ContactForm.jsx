      ...
      <div className="row form1 d-flex align-items-center">
        ...
        <div className="col-md-6">
          ...
          >
            ...
            <label htmlFor="Email" style={{ marginRight: '360px' }}>
              Email
            </label>
            <input type="email" placeholder="Email" id="Email" name="Email" />

            <label htmlFor="batches" style={{ marginRight: '290px' }}>
              Choose a batch
            </label>
            ...
            <label htmlFor="message" style={{ marginRight: '330px' }}>
              Message
            </label>
        ...
        <div className="col-md-6">
          <div className="body d-flex align-content-center justify-content-center flex-column">
            <div className="gallery text-center overflow-hidden">
              <img
                className="d-block"
                src="Images/Gallery/Best SEO Institute in Dera Bassi.jpeg"
                alt="Best SEO Institute in Dera Bassi"
              />
              <img
                className="d-block"
                src="Images/Gallery/Benefits Of SEO Training.jpeg"
                alt="Best SEO Training in Zirakpur"
              />
              <img
                className="d-block"
                src="Images/Gallery/SEO Training For Beginners.jpeg"
                alt="SEO Training For Beginners"
              />
              <img
                className="d-block"
                src="Images/Gallery/Best Online Marketing Courses in Zirakpur.jpeg"
                alt="Best Digital Marketing Courses in Zirakpur"
              />
              <img
                className="d-block"
                src="Images/Gallery/SEO Training With Placement Zirakpur.jpeg"
                alt="Best Digital Marketing Institute in Zirakpur"
              />
              <img
                className="d-block"
                src="Images/Gallery/Beginner SEO Courses Zirakpur.jpeg"
                alt="Top SEO Coaching in Zirakpur"
              />
              <img
                className="d-block"
                src="Images/Gallery/Best Digital Marketing Training in Dera Bassi.jpeg"
                alt="Best Digital Marketing Training in Dera Bassi"
              />
              <img
                className="d-block"
                src="Images/Gallery/Best Digital Marketing Courses in Dera Bassi.jpeg"
