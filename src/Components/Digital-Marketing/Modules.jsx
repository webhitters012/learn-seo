...
const topics = [
  {
    ...
    content:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis vero nisi dolor maxime aperiam eos. Rem ad aliquam, iusto id praesentium molestiae suscipit voluptas voluptates vitae impedit eius magnam nesciunt.',
    ...
    <div>
      <div className="main-box-of-models-heading-text">
        <div className="box-of-models-heading-text">
          <h1>
            What You’ll Learn in Our <span>Digital Marketing Course</span> and Training with
            Real-time Projects and Case Studies
          </h1>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum laborum vero accusantium
            saepe magni error, itaque deserunt. In nobis architecto vero. Placeat laborum esse
            quaerat omnis reprehenderit aspernatur nisi quas!
          </p>
        </div>
      </div>
      <br />
          ...
          {topics.map((item, index) => (
            <div key={index} className="module-item">
              <div className="module-header" onClick={() => toggleExpand(index)}>
                ...
                <button className="module-button">{expandedIndex === index ? '−' : '+'}</button>
              </div>
              {expandedIndex === index && (
