    ...
    <div className="main-div-of-about-digital-marketing">
      <div className="both-div-of-text-section">
        <div className="div-of-about-digital-marketing">
          ...
          <p>
            The digital marketing industry in India has been growing rapidly over the past decade,
            driven by increasing internet penetration, a rise in smartphone usage, and a burgeoning
            e-commerce sector. Here are some key aspects of the industry:
            <br />
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi quia nostrum aspernatur,
            excepturi commodi ad, voluptate eius, vitae optio repellendus ratione maiores
            accusantium voluptatum aperiam itaque numquam laudantium mollitia dignissimos! aperiam
            itaque numquam
          </p>
        </div>
