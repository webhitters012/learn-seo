...
const RatingsAndReviews = () => {
  ...
  const slides = [
    ...
    {
      src: './Images/Hiring-Partners/BEST-IELTS-COACHING-INSTITUTE-IN-CHANDIGARH.png',
      alt: 'Test-Ilets',
    },
    ...
    {
      src: './Images/Hiring-Partners/SCHOLARS---The-Visa-Destination.png',
      alt: 'SCHOLARS---The-Visa-Destination',
    },
