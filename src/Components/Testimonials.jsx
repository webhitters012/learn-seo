...
const testimonials = [
  ...
  },
  {
    ...
    img: 'Images/reviews/neenu sekhon review.png',
    name: 'Neenu sekhon',
    rating: '5/5',
  },
  {
    ...
    <div className="testimonial-wrapper">
      <div className="testimonial-container container">
        <h2 className="text-center heading-size-small">
          <b>
            What <span style={{ color: '#de3335' }}>Our Students</span> Say
          </b>
        </h2>
        <div
        ...
        <div className="text-center mt-3">
          <a
            href="https://www.google.com/search?hl=en-IN&gl=in&q=Learn+SEO+and+Web+Design"
            target="_blank"
