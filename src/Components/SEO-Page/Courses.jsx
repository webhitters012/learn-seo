...
const seoModules = [
  {
    ...
    details: [
      ...
      'Need Of SEO',
      'Things to Keep In Mind Before Getting Started With SEO of Website',
      'What is Ranking',
      'What is SERP',
  ...
  },
  {
    ...
    details: [
      ...
      'Decide on a Content Management System (CMS)',
      'Plan Website Structure and Navigation',
      'WordPress Installation',
      'WordPress Overview',
      'Important Plugins Overview',
      'Website Designing Using Elementor, Divi, WPBakery etc.',
    ...
    image: '/Images/SEO-Course/2.jpg',
  },
  {
    id: 'content3',
    title: 'Keyword Research',
    details: [
      'Introduction To Keyword Researchs',
      'Types of keywords',
      'Long-Tail vs. Short-Tail Keywords',
      'Why and How to choose the right keywords?',
      'Tools for keyword research – Free and Paid',
      'Keyword Organization and Mapping',
      'Analyzing and Monitoring Keyword Performance',
      'Understanding Keyword Properties',
      'How to Find Competition?',
      'How to Add Keywords in Content?',
      'Implementing Keywords into Content and SEO',
    ],
  ...
  },
  {
    ...
    details: [
      ...
      'Understanding Google Business Profile Policy',
      'Local SEO Ranking Factors',
      'Local Citations and Directory Listings',
      'Customer Reviews and Reputation Management',
      'Google Business Profile Dashboard Overview',
      'Make a Free Google Business Profile Website',
      'How to Optimize Local SEO to Rank on the Top',
    ],
    image: '/Images/SEO-Course/5.jpg',
  },
  {
    id: 'content6',
    title: 'On-Page SEO',
    details: [
      ...
      'URL Structure',
      'Length of Article',
      'How to publish your article in WordPress?',
      'How to improve On-Page SEO score',
      'On-Page SEO Plugins List',
    ],
    image: '/Images/SEO-Course/6.jpg',
  },
  {
    id: 'content7',
    title: 'Off-Page SEO',
  ...
  },
  {
    ...
    details: [
      ...
      'Google Search Console and its Setup',
      'Google Search Console and its Setup',
      'Google Analytics',
      'Bing Webmaster',
  ...
  },
  {
    ...
    details: [
      ...
      'Creating a Google Analytics GA4 Property',
      'Google Analytics Dashboard Overview',
      'Real-Time Audience Overview',
      'Audience Overview',
      'Acquisition',
      'Engagement',
      'Understanding Events and Event-Based Tracking',
      'Conversion',
      'Monetisation',
      'Regular Analysis and Optimization',
    ],
    image: '/Images/SEO-Course/9.jpg',
  },
  {
    id: 'content10',
    title: 'Free & Paid SEO Tools',
    details: [
      'Keyword Planner',
    ...
    image: '/Images/SEO-Course/10.jpg',
  },
  {
    id: 'content11',
    title: 'An Overview of Social Media Optimization',
    details: [
      ...
      'User Experience (UX)',
      'Incorporate Emojis and Visual Elements',
      'Stay Updated on Platform Changes',
    ],
    image: '/Images/SEO-Course/11.jpg',
  },
  {
    id: 'content12',
    title: 'Facebook',
    details: [
      ...
      'Facebook Insights for Business',
      'Facebook Pixel and Conversion Tracking',
      'Video Content Strategy',
      'Managing Facebook Reputation',
      'Advanced Ad Strategies',
      'Facebook Stories and Visual Content',
      'Crisis Management on Facebook',
      'Facebook for Nonprofits',
      'Facebook Advertising Budgeting',
    ],
    image: '/Images/SEO-Course/12.jpg',
  },
  {
    id: 'content13',
    title: 'Instagram',
    details: [
      ...
      'Instagram IGTV and Video Marketing',
      'Instagram Live and Live Streaming',
      ...
      'Instagram Aesthetics and Branding',
      'Instagram Engagement Campaigns',
      'Instagram Stories Ads and Strategies',
      'Instagram Insights Interpretation',
    ],
    image: '/Images/SEO-Course/13.jpg',
  },
  {
    id: 'content14',
    title: 'Twitter',
  ...
  },
  {
    ...
    details: [
      ...
      'Using LinkedIn Posts and Articles',
      'Engagement and Interaction on LinkedIn',
      'Personal Branding on LinkedIn',
      'LinkedIn Profile Optimization',
      'LinkedIn Endorsements and Recommendations',
      'LinkedIn Job Search and Opportunities',
      ...
      'LinkedIn Profile Privacy and Security',
      'LinkedIn Influencer Strategies',
      'Maximizing LinkedIn Recommendations',
      'LinkedIn Learning Platform',
      'Using LinkedIn for Business Development',
    ],
    image: '/Images/SEO-Course/15.jpg',
  },
  {
    id: 'content16',
    title: 'YouTube',
