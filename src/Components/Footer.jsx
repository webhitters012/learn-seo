      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col">
            ...
            <p onClick={() => navigate('/SEO')}>SEO Courses (90 days)</p>
            <p>Web Design Course</p>
            <p onClick={() => navigate('/DM')}>Digital Marketing Courses</p>
            <p>Graphic Design Courses</p>
          </div>
          <div className="col">
        ...
        <div className="row def">
          ...
          <p className="iyu">
            Copyright © 2025 Learn SEO & Web Designing Chandigarh | Design By{' '}
            <a href="https://www.web-hitters.com/">Web Hitters</a>
          </p>
        </div>
      </div>
    </footer>
